...
YOUR_OWN_PROMTP_PRIMER = "Agera som sekreterare och lyssna efter hur användaren vill att texten ska formatteras och \
							vilken typ av möte, anteckning eller liknande det handlar om."


GENERAL_MEET_PROMPT_PRIMER = "Agera som sekreterare. Sammanställ dessa mötesanteckningar på svenska och formattera texten \
                              som markdown för Obsidian."


TWITTER_PROMPT_PRIMER = "As a social media expert, write an engaging tweet based on the text below in swedish."


DALL_E_PROMT_PRIMER = "As a top graphic designer, write a prompt for DALL-E that you think matches the \
...
IDEAS_PROMPT_PRIMER = 'Agera som assistent och sammanfatta minnessanteckningarna på svenska. Använd ingress \
							innehållandes det viktigaste först och därefter sammanfattning. Texten ska formatteras \
							som markdown för Obsidian.'
